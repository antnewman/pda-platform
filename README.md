...
**121 tools · 18 modules · Production-deployed · Published on PyPI**

---

PDA Platform gives Claude and other MCP-compatible AI assistants **121 structured tools** to perform rigorous, evidence-based project delivery assurance aligned to IPA Gate Reviews (Gates 0–5), HM Treasury Green Book appraisal, and GMPP reporting standards. It is the only open-source MCP platform specifically designed for Senior Responsible Owners, Project Managers, Independent Assurance Reviewers, and Portfolio Managers working in UK government major project delivery.
...
## What Claude can do with 121 tools
...
| pm-assumptions | 5 | Assumption drift detection, confidence scoring, live external signal integration (ONS, World Bank), cascade analysis, UDS dashboard |
| **Total** | **121** | One unified endpoint · One connection |
...
│   ├── pm-mcp-servers/         18 MCP modules, 121 tools for AI integration
...
| [MCP Tools Reference](docs/mcp-tools-reference.md) | Parameter-level reference for all 121 tools |
...
**Run tests:**
```bash
cd packages/pm-mcp-servers && python -m pytest   # 75 tests, 121 tools
